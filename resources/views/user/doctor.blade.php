      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img style="height: 300px !important" src="doctorimage/{{ $doctors->image }}" alt="Doctor Image">
              <div class="meta">
            ...
            <div class="body">
              <p class="text-xl mb-0">{{ $doctors->name }}</p>
               <span class="text-xl text-grey text-capitalize">{{ $doctors->speciality }}</span><br>
              <span class="text-sm text-grey">{{ $doctors->message }}</span>
